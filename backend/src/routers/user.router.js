...
UserRouter.route("/").post(body("email", "Email must be a valid email.").isEmail(),
    ...
    UserController.saveUser).get(UserController.findAll);
    UserRouter.route("/").post(UserController.saveUser).get(UserController.findAll);
